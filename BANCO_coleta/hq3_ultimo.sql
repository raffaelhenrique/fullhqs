...
--
-- Host: 127.0.0.1
-- Generation Time: 06-Jul-2017 às 23:44
...
(16, 38, 'Devianart', '1498636630595361566f671.jpg', 'https://drive.google.com/open?id=0B0mji950XSt1N050NzdabXdINjA'),
(17, 38, 'New #52', '14986366655953617946df9.jpg', 'https://drive.google.com/open?id=0B0mji950XSt1Ry1jdFdaeTg0WFk'),
...
(7, 'DC Rebirth', '#1', 2, 16, 3, 77, 38, '14986282055953406d587b1.jpg', 'https://drive.google.com/file/d/0B-ZWbNluP6bIYThBeWpwcjF4REk/view'),
(8, 'DC Rebirth', '#2', 2, 15, 3, 77, 38, '1498628292595340c408646.jpg', 'https://drive.google.com/file/d/0B5gwhV75l41OcmI5Qnd2SjdVU0E/view?usp=drive_web'),
(11, 'DC Rebirth', '#3', 2, 16, 3, 77, 38, '14986286545953422ee4cab.jpg', 'https://drive.google.com/file/d/0B6TOttXQ3smAMHJITS1qMjVJRFE/view'),
(12, 'DC Rebirth', '#4', 2, 15, 2, 77, 38, '1498628772595342a4bceef.jpg', 'https://drive.google.com/file/d/0B5gwhV75l41OWm1hUlpJQjJIczA/view?usp=drive_web'),
...
(27, 'DC Renascimento', '#2', 2, 16, 3, 77, 40, '14986304285953491c51ecc.jpg', 'https://drive.google.com/file/d/0B1Y6-1KXxg2VSFJ1U2pwNm5lQmc/view?usp=drive_web'),
...
(37, 'Deadpool a Guerra de wade wilson', 'V#03', 5, 14, 3, 77, 50, '14986323145953507a9259c.jpg', 'https://drive.google.com/file/d/0B42vE_NdhWtRSnZpbFBOLUFJM2s/view'),
(38, 'Doutor Estranho V4', 'V#01', 5, 14, 3, 77, 46, '14986324905953512a6726c.jpg', 'https://drive.google.com/file/d/0BwKfIdxaLNbXLWc2ZXlBTHUtV0E/view'),
...
(49, 'Velho Logan', 'Vol.07 - 18', 5, 14, 3, 77, 49, '14986338365953566c856c6.jpg', 'https://drive.google.com/drive/folders/0B0lue65R4P4WeGZHSGtLUGk2MEk');
...
CREATE TABLE `paginasmovimento` (
  `idmovimento` bigint(20) UNSIGNED NOT NULL,
...
(83, '/fullhqs/index.php?pg=personagens&id=38', 0, 38, 0),
...
(91, '/fullhqs/index.php?pg=hqs&id=38', 38, 0, 0),
...
ALTER TABLE `galeria`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_galeria_personagens1_idx` (`id_personagens`);
...
ALTER TABLE `noticia`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_noticia_usuario_sistema1_idx` (`id_usuario`);

--
-- Indexes for table `paginasmovimento`
--
ALTER TABLE `paginasmovimento`
  ADD UNIQUE KEY `idmovimento` (`idmovimento`);
...
ALTER TABLE `personagens`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_personagens_categoria1_idx` (`id_editora`);
...
ALTER TABLE `post`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_post_usuario_sistema1_idx` (`id_usuario`);
...
--
-- AUTO_INCREMENT for table `paginasmovimento`
--
ALTER TABLE `paginasmovimento`
  MODIFY `idmovimento` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=150;
--
